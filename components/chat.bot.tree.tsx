...
const chatTree: ChatOption = {
    ...
    options: [
            ...
            options: [
                // subopción de tallas
                {
                    ...
                    options: [
                        // más opciones dentro de tallas
                        {
                            text: "Smartphones",
                            response:
                                "Tenemos una amplia gama de smartphones de las mejores marcas.",
                        },
                        {
                            text: "Laptops",
                            response:
                                "Ofrecemos laptops para todos los usos, desde básicas hasta gaming.",
                        },
                        {
                            text: "Accesorios",
                            response: "Disponemos de todo tipo de accesorios electrónicos.",
                        },
                    ],
                },
                // subopción de calzado
                {
                    ...
                    options: [
                        ...
                        {
                            text: "Casual",
                            response: "Para un evento especial .. mira este link ...",
                        },
                        {
                            text: "Deportivos",
                            response:
                                "este es un link para que veas los diferentes estilos .",
                        },
                        {
                            text: "Casa",
                            response: "Disponemos todas las marcas aqui un link para ir a .",
                        },
                    ],
                },
                // subopción de deportivos
                {
                    ...
                    options: [
                        // tipos de deportivos
                        {
                            text: "Hombre",
                            response:
                                "Nuestra colección para hombres incluye camisas, pantalones, trajes y más.",
                        },
                        {
                            text: "Mujer",
                            response:
                                "Para mujeres tenemos vestidos, blusas, pantalones y accesorios.",
                        },
                        {
                            text: "Niños",
                            response:
                                "Ropa cómoda y duradera para niños de todas las edades.",
                        },
                    ],
                },
                // subopción de hogar
                {
                    ...
                    options: [
                        // tipos de productos para el hogar
                        {
                            text: "Muebles",
                            response:
                                "Ofrecemos muebles para todas las habitaciones de tu hogar.",
                        },
                        {
                            text: "Decoración",
                            response:
                                "Encuentra accesorios decorativos para darle estilo a tu casa.",
                        },
                        {
                            text: "Electrodomésticos",
                            response: "Tenemos electrodomésticos de las mejores marcas.",
                        },
                    ],
                },
            ],
        ...
        // opción de ofertas
        {
            text: "Ofertas",
            response:
                "Actualmente en VERI tenemos descuentos de hasta el 50% en productos seleccionados.",
        },
        // opción de atención al cliente
        {
            ...
            options: [
                // tipos de atención al cliente
                {
                    text: "Devoluciones",
                    response:
                        "Puedes devolver tu producto en un plazo de 30 días tras la compra.",
                },
                {
                    text: "Envíos",
                ...
                },
                {
                    text: "Contacto",
                    response:
                        "Puedes contactarnos en el teléfono 3147327452 o por email a info@tienda.com",
                },
            ],
        },
        // opción de mi cuenta
        {
            ...
            options: [
                // opciones de la cuenta
                {
                    text: "Mis pedidos",
                    response:
                        "Aquí podrás ver el estado de tus pedidos actuales y anteriores.",
                },
                {
                    text: "Mis datos",
                    response: "Puedes actualizar tu información personal y de envío.",
                },
                {
                    text: "Mis favoritos",
                    response: "Accede a tu lista de productos favoritos.",
                },
            ],
        },
    ],
...
const ChatTree: React.FC = () => {
    ...
    const showMenu = () => {
        if (currentOption.options) {
            const menuOptions = currentOption.options
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (userInput.toLowerCase() === "menu") {
            ...
            if (
                ...
                selectedIndex >= 0 &&
                selectedIndex < currentOption.options.length
            ) {
                ...
                if (selectedOption.response) {
                    ...
                    setConversation((prev) => [
                        ...prev,
                        'Escribe "menu" para volver al menú principal o haz otra pregunta.',
                    ]);
                ...
                setConversation((prev) => [
                    ...prev,
                    'Opción no válida. Por favor, intenta de nuevo o escribe "menu" para ver las opciones.',
                ]);
            }
        }
            ...
            <div className="conversation" ref={conversationRef}>
                {conversation.map((message, index) => (
                    <div
                        key={index}
                        className={
                            message.startsWith("Usuario:") ? "userMessage" : "botMessage"
                        }
                    >
                        {message}
                    </div>
